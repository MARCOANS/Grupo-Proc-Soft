...
<footer class="site-footer footer-v1" id="colophon">
    <div class="col-full">
        ...
        <div class="site-address">
            <ul class="address">
                ...
                <li>
                    901-947 South Drive, Houston, TX 77057, USA
                </li>
                <li>
        ...
        <div class="site-info">
            <p class="copyright">
                Copyright © 2017 Pizzaro Template. All rights reserved.
            </p>
        </div>
        <!-- .site-info -->
        <a class="footer-action-btn" data-toggle="collapse" href="#footer-map-collapse" role="button">
                    ...
                    <div class="site-search">
                        <div class="widget woocommerce widget_product_search">
                            <form class="woocommerce-product-search" method="get" role="search">
                                ...
                                <input class="search-field" id="woocommerce-product-search-field" name="s" placeholder="Search Products…" title="Search for:" type="search" value=""/>
